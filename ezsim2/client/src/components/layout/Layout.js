...
import { FiMenu, FiX, FiUser, FiLogOut, FiHome, FiBookOpen, FiDollarSign, FiInfo, FiPhone } from 'react-icons/fi';
...
const Layout = () => {
  ...
  const navigation = [
    ...
    { name: 'Exams', href: '/exams', icon: FiBookOpen },
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">IELTS Simulator</span>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">IELTS Simulator</span>
              </div>
              <p className="text-gray-400 mb-4 max-w-md">
                Comprehensive IELTS exam preparation platform with authentic practice tests, 
                real-time feedback, and expert guidance to help you achieve your target score.
              </p>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            <p className="text-gray-400 text-sm text-center">
              © 2024 IELTS Simulator. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
